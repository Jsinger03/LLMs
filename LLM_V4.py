...
prompt_template_menu = PromptTemplate(
    ...
    template = "I want to open a restaurant called {restaurant_name}. Suggest menu items for this restaurant. Return as a comma separated list"
)


chain_menu = LLMChain(llm = app_llm, prompt = prompt_template_menu)
menu = chain_menu.run(name)
print(menu)